...
module.exports = GojoMdNx = async (GojoMdNx, m, chatUpdate, store) => {
    try {
        ...
        const isCreator = isPremium || [botNumber, ...global.owner].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(m.sender)
...
اهلا وسهلا انا بوت غوجو تحت الخدمة انا اساعدكم وصديقكم الوفي 🫂💋

سئكون دائماً هنا فقط قول اين غوجو وسئاتي اليك 
            💎

اتمنة ان ينال البوت اعجابكم 
          ❤😍
المطورين 
{  إسلام  }[]{ خير }

  ان كنت تريد البوت في جروبك راسلني[+201097553223][+201119558517]`,
